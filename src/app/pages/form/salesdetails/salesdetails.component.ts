...
export class SalesdetailsComponent implements OnInit {
  ...
  closingamt = new InceData;
  souringamt = new InceData;
  addInce = new AddInce;
  ...
  ngOnInit(): void {
    ...
    this.salesdetails.case_payout_percentage = 0;
    this.salesdetails.extra_payout_percentage = 0;
    this.salesdetails.shared_payout = 0;
  ...
  getSalesdetails(){
    this.dataservice.getbookingid().subscribe(res=>{
      ...
      this.booking_id = this.bookingdata[0].booking_id; 
      var str1 = this.booking_id.replace(/\D/g, "");
console.log(str1);
      this.value = Number(str1) + Number(1);
      this.salesdetails.booking_id = 'HFP-'+this.value;
    })
  }
  ...
  getBusinessValue1(event) {
    this.consideration_value = event.target.value;
    this.getBusinessValue();
  }
  getBusinessValue2(event) {
    this.shared_payout_value = event.target.value;
    this.getBusinessValue();
  }
  getBusinessValue3(event) {
    this.leadsource_id = event.target.value;
    this.getBusinessValue();
  }
  submitSalesdetails() {
    this.dataservice.registerSalesdetails(this.salesdetails).subscribe(
  ...
  getSalesIncentive(){
    ...
    this.dataservice.getInceSourcing(this.sourcingD).subscribe(res => {
      ...
      if(this.sourcingD.LeadCount >= 3){
        this.eligibility_ince = "Yes";
      }else{
        this.eligibility_ince = "No";
      }
  ...
  getSalesIncentiveC(){
    ...
    // console.log('booking_datesplit',this.booking_datesplit);
  ...
  handleResponse(data) {
    ...
    Swal.fire('Added!', 'Sales Details has been added.', 'success');
    this.router.navigateByUrl('/form/salesdetailslist');
  }
  ...
  get bmi3() {
    ...
    var ankita2 = Number(this.salesdetails.payout_value) * Number(this.salesdetails.shared_payout) / 100;
